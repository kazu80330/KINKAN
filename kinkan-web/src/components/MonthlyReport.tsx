  ...
  return (
    <div className="report-container">
      <div className="report-controls glass-panel" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '24px' }}>
        ...
        <button className="btn-outline btn-sm">⬇ .xlsx エクスポート</button>
      </div>
      ...
      <div className="table-card glass-panel" style={{ overflowX: 'auto' }}>
        <h3 className="section-title">月次勤務記録</h3>
            ...
            {[...Array(daysInMonth)].map((_, i) => {
              ...
              return (
                ...
                >
                  ...
                  <td style={{ padding: '12px', color: r?.clockOut ? 'var(--text)' : 'var(--text-dim)' }}>
                    {r?.clockOut ? r.clockOut.slice(0, 5) : '—'}
                  </td>
